...
visualisation_1_courbe(total_price_deals_monthly)
...
total_price_deals_monthly_prediction = total_price_deals_monthly_prediction(predictions)
#Visualisation par mois
visualisation_1_courbe(total_price_deals_monthly_prediction)
